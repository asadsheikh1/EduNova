...
//   }) async {
//     final url = Uri.parse('https://us-central1-edu-nova-2507a.cloudfunctions.net/StripePayEndpointIntentId');
...
//   }) async {
//     final url = Uri.parse('https://us-central1-edu-nova-2507a.cloudfunctions.net/StripePayEndpointMethodId');
//     final response = await http.post(
//       url,
//       headers: {'Content-Type': 'application/json'},
//       body: json.encode(
